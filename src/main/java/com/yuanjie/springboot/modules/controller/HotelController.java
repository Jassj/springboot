...
public class HotelController {
    ...
    public List<HotelResourceDetail> searchDetail(@RequestBody List<Integer> hotelIds) {
    ...
    public List<HotelResourceDetail> score(@RequestBody List<JSONObject> hotelDimensions) {
